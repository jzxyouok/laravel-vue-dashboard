...
export default {
    ...
    template: `
         <grid :position="grid" modifiers="overflow scroll padded blue">
            <section class="service-bureau-calendar">
                <h1 class="calendar__title">Service Bureau Events</h1>
    ...
    methods: {
        getEventHandlers() {
            return {
                'GoogleCalendar.ServiceBureauEventsFetched': response => {
        ...
        getSavedStateId() {
            return 'service-bureau-calendar';
        },
    },
};
